...
#
# $Id: generate-update-sql.sh,v 1.2 2006/07/13 21:01:56 trolsen Exp $
# ---------------------------------------------------------------------------
...
cd "$XDAT_HOME"
echo "Executing $MAVEN_HOME/bin/maven xdat:generateUpdateSQL"
"$MAVEN_HOME"/bin/maven xdat:generateUpdateSQL $*
