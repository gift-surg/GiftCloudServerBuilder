...
#
# $Id: quick-deploy-templates.sh,v 1.1 2007/01/04 23:07:52 timo Exp $
# ---------------------------------------------------------------------------
...
cd "$XDAT_HOME"
echo "Executing $MAVEN_HOME/bin/maven xdat:quick-deploy"
"$MAVEN_HOME"/bin/maven xdat:quick-deploy-templates $*
