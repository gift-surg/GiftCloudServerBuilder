...
public class DicomSCPManager {
	...
	public void startOrStopDicomSCPAsDictatedByConfiguration() {
		...
		try {
			Boolean enableDicomReceiver = Boolean.valueOf(XDAT
					.getSiteConfigurationProperty("enableDicomReceiver"));
			...
			throw new RuntimeException(
					"unable to lookup enableDicomReceiver property from config service",
					e);
		} catch (IOException e) {
