...
public class CompositeDicomObjectIdentifier implements
	...
	public CompositeDicomObjectIdentifier(
			...
			final Extractor subjectExtractor, final Extractor sessionExtractor,
		...
		ImmutableSortedSet.Builder<Integer> builder = ImmutableSortedSet
				.naturalOrder();
	...
	public CompositeDicomObjectIdentifier(
		...
		this(projectID, new ChainExtractor(subjectExtractors),
				new ChainExtractor(sessionExtractors), new ChainExtractor(
						aaExtractors));
	}
	 ...
	 * 
	 * @see
	 * org.nrg.xnat.DicomObjectIdentifier#getProject(org.dcm4che2.data.DicomObject
	 * )
	 */
	 ...
	 * 
	 * @see
	 * org.nrg.xnat.DicomObjectIdentifier#getSessionLabel(org.dcm4che2.data.
	 * DicomObject)
	 */
	 ...
	 * 
	 * @see
	 * org.nrg.xnat.DicomObjectIdentifier#getSubjectLabel(org.dcm4che2.data.
	 * DicomObject)
	 */
	...
	private static final Pattern TRUE = Pattern.compile("t(?:rue)?",
			Pattern.CASE_INSENSITIVE);
	private static final Pattern FALSE = Pattern.compile("f(?:alse)?",
			Pattern.CASE_INSENSITIVE);
	 ...
	 * 
	 * @see
	 * org.nrg.xnat.DicomObjectIdentifier#requestsAutoarchive(org.dcm4che2.data
	 * .DicomObject)
	 */
