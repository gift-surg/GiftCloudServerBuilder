...
public class PipelineFileUtils {
	...
	public static PipelineDocument GetDocument(String pathToPipelineXmlFile)
			throws Exception {
		if (!pathToPipelineXmlFile.endsWith(".xml"))
			pathToPipelineXmlFile += ".xml";
		...
		if (!(xo instanceof PipelineDocument)) {
			throw new Exception("Invalid XML file supplied "
					+ pathToPipelineXmlFile
					+ " ==> Expecting a pipeline document");
		}
	...
	public static String getMaxMatching(String file1, String file2,
			String scanId1, String scanId2) {
		String rtn = null;
		if (file1 == null || file2 == null || scanId1 == null
				|| scanId2 == null)
			return null;
		int index = 0;
		while (true) {
