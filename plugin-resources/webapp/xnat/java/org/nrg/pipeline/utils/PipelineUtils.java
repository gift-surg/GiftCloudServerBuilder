...
public class PipelineUtils {
	...
	public static String getNextAutoArchiveStepId(
			ArcProjectDescendant arcProjectDesc) {
		...
		List<ArcProjectDescendantPipelineI> pipelines = arcProjectDesc
				.getPipeline();
		...
		if (projectHasAutoArchive) {
			if (bins != null && bins.size() > 0) { // More than 1 AutoArchive
													// have been defined
