...
public abstract class BaseArcArchivespecification extends
		AutoArcArchivespecification implements NotificationSubscriberProvider {
	...
	public String[] getSubscribers(NotificationType notificationType) {
		for (ArcArchivespecificationNotificationTypeI type : getNotificationTypes_notificationType()) {
			if (type.getNotificationType().equalsIgnoreCase(
					notificationType.id())) {
				String[] addresses = type.getEmailAddresses().split(
						"[\\s]*,[\\s]*");
	...
	public boolean isComplete() {
		...
		if (this.getSiteAdminEmail() == null
				|| this.getSiteAdminEmail().equals("")) {
			return false;
		}
		...
		if (this.getGlobalpaths().getArchivepath() == null
				|| this.getGlobalpaths().getArchivepath().equals("")) {
			return false;
		}

		if (this.getGlobalpaths().getPrearchivepath() == null
				|| this.getGlobalpaths().getPrearchivepath().equals("")) {
			return false;
		}

		if (this.getGlobalpaths().getCachepath() == null
				|| this.getGlobalpaths().getCachepath().equals("")) {
			return false;
		}

		if (this.getGlobalpaths().getBuildpath() == null
				|| this.getGlobalpaths().getBuildpath().equals("")) {
			return false;
		}

		if (this.getGlobalpaths().getFtppath() == null
				|| this.getGlobalpaths().getFtppath().equals("")) {
			return false;
		}
