...
public abstract class BaseWrkXnatexecutionenvironmentNotify extends
		AutoWrkXnatexecutionenvironmentNotify {
	...
	public BaseWrkXnatexecutionenvironmentNotify(Hashtable properties,
			UserI user) {
