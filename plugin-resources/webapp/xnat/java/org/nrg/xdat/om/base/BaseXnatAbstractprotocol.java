	...
	public XdatStoredSearch getDefaultSearch(XnatProjectdata project) {
		...
		try {
			...
			if (this.getName() != null)
				...
				xss.setBriefDescription(ElementSecurity.GetElementSecurity(
						this.getDataType()).getPluralDescription());
			}
