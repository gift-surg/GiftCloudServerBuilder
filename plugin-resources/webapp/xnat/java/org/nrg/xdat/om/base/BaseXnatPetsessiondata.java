...
public class BaseXnatPetsessiondata extends AutoXnatPetsessiondata {
	...
	public void copyValuesFrom(XnatImagesessiondata otherImage)
			throws Exception {
		...
		if (otherImage instanceof XnatPetsessiondata) {
			...
			if (null != tempPET.getTracer_isotope_halfLife())
				this.setTracer_isotope_halfLife(tempPET
						.getTracer_isotope_halfLife());
			...
			if (null != tempPET.getTracer_specificactivity())
				this.setTracer_specificactivity(tempPET
						.getTracer_specificactivity());
			...
			if (null != tempPET.getTracer_totalmass_units())
				this.setTracer_totalmass_units(tempPET
						.getTracer_totalmass_units());
	...
	public Map<String, String> getCustomScanFields(String project) {
		...
		customheaders
				.put("RFilter resolution", "parameters/RFilter/resolution");
		...
		customheaders
				.put("ZFilter resolution", "parameters/ZFilter/resolution");
		...
		customheaders.put("ecat Calibration Factor",
				"parameters/ecatCalibrationFactor");
