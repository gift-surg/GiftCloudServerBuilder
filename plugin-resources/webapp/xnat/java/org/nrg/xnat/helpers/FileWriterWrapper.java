...
public class FileWriterWrapper implements FileWriterWrapperI {
	...
	public FileWriterWrapper(final Representation representation,
			final String name) {
		this.fi = null;
	...
	public FileWriterWrapper(final Representation representation,
			final String name, final String nestedPath) {
		this.fi = null;
		this.entry = representation;
		this.name = name;
		this.nestedPath = nestedPath;
	...
	public UPLOAD_TYPE getType() {
		return null == entry ? FileWriterWrapperI.UPLOAD_TYPE.MULTIPART
				: FileWriterWrapperI.UPLOAD_TYPE.INBODY;
	}
