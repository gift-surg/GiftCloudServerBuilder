...
public final class CopyOp<A> extends Transaction {
	...
	public CopyOp(Callable<A> op, File dir, File rootBackup,
	...
	public CopyOp(Callable<A> op, File dir, File rootBackup,
			String backupDirName, LoggerI logger) {
		this.op = op;
		this.dir = dir;
		this.rootBackup = rootBackup;
		this.backupDirName = backupDirName;
	...
	private void rollbackHelper(File backupDIR, File destDIR, boolean overwrite)
