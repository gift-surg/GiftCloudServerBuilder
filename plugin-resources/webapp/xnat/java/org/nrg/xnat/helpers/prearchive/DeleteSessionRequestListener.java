...
public class DeleteSessionRequestListener {
	...
	public void onDeleteSessionRequest(
			final DeleteSessionRequest deleteSessionRequest) throws Exception {
		try {
			...
			try {
				...
				PrearcDatabase.deleteSession(sessionData.getFolderName(),
			...
			log.error("Choked on request " + deleteSessionRequest
	...
	private final static Logger log = LoggerFactory
			.getLogger(DeleteSessionRequestListener.class);
}
