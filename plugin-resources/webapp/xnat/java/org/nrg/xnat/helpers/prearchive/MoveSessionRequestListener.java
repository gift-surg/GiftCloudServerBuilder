...
public class MoveSessionRequestListener {
	...
	public void onMoveSessionRequest(final MoveSessionRequest moveSessionRequest)
			throws Exception {
		try {
			...
			try {
				...
				PrearcDatabase.moveToProject(sessionData.getFolderName(),
			...
			log.error("Choked on request " + moveSessionRequest
	...
	private final static Logger log = LoggerFactory
			.getLogger(MoveSessionRequestListener.class);
}
