...
public final class SessionData implements Serializable {
	...
	private String scan_time, subject, url, session, tag, source, visit,
			protocol, timeZone;
		...
		if (null != object) {
			...
			if (object instanceof String) {
				...
				throw new ClassCastException(
						"The object submitted for auto-archive must be a String, Integer, or PrearchiveCode; the submitted class is invalid for casting to PrearchiveCode: "
								+ object.getClass());
			}
	...
	public String getExternalUrl() {
		return String.format("/prearchive/projects/%s/%s/%s", getProject(),
				getTimestamp(), getFolderName());
	}
