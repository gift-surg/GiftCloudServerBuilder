...
public abstract class SessionDataDelegate implements SessionDataProducerI,
		SessionDataModifierI {
	...
	public void setSp(SessionDataProducerI sp) {
		this.sp = sp;
	};

	public void setSm(SessionDataModifierI sm) {
		this.sm = sm;
	}

	public SessionDataProducerI getSp() {
		return sp;
	}

	public SessionDataModifierI getSm() {
		return sm;
	};
