...
public class SessionDataTriple implements Serializable {
	...
	public static SessionDataTriple makeTriple(String sess, String timestamp,
			String proj) {
		return new SessionDataTriple().setFolderName(sess).setProject(proj)
	...
	public static SessionDataTriple fromFile(final String project, final File f) {
		return new SessionDataTriple().setFolderName(f.getName())
				.setProject(project).setTimestamp(f.getParentFile().getName());
	}
	...
	public static SessionDataTriple fromPrearcSession(
