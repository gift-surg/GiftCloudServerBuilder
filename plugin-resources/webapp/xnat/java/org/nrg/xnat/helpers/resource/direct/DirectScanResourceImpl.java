...
public class DirectScanResourceImpl extends ResourceModifierA {
	...
	public DirectScanResourceImpl(final XnatImagescandata scan,
			final XnatImagesessiondata session, final boolean overwrite,
	 ...
	 * 
	 * @see
	 * org.nrg.xnat.helpers.resource.DirectResourceModifierA#buildDestinationPath
	 * ()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.nrg.xnat.helpers.resource.DirectResourceModifierA#addResource(org
	 * .nrg.xdat.om.XnatResource)
	 */
	@Override
	public boolean addResource(final XnatResource resource, final String type,
