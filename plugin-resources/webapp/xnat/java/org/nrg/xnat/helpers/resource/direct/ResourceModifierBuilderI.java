...
public interface ResourceModifierBuilderI {
	...
	public abstract ResourceModifierA buildResourceModifier(
	...
	public abstract void setSubject(XnatProjectdata project,
			XnatSubjectdata subject);

	public abstract XnatSubjectdata getSubject();

	public abstract void setExpt(XnatProjectdata project,
			XnatExperimentdata expt);

	public abstract XnatExperimentdata getExpt();

	public abstract void setAssess(XnatImagesessiondata assessed,
			XnatImageassessordata assess, String type);

	public abstract XnatImageassessordata getAssess();

	public abstract void setScan(XnatImagesessiondata assessed,
			XnatImagescandata scan);

	public abstract XnatImagescandata getScan();

	public abstract void setRecon(XnatImagesessiondata assessed,
