...
public class XMLPathShortcuts implements XMLPathShortcutsI {
	...
	private XMLPathShortcuts() {
		...
		this.addShortCut(IMAGE_SCAN_DATA, "quality",
				"xnat:imageScanData/quality");
		this.addShortCut(IMAGE_SCAN_DATA, "condition",
				"xnat:imageScanData/condition");
		this.addShortCut(IMAGE_SCAN_DATA, "series_description",
				"xnat:imageScanData/series_description");
		this.addShortCut(IMAGE_SCAN_DATA, "documentation",
				"xnat:imageScanData/documentation");
		this.addShortCut(IMAGE_SCAN_DATA, "scanner",
				"xnat:imageScanData/scanner");
		this.addShortCut(IMAGE_SCAN_DATA, "modality",
				"xnat:imageScanData/modality");
		this.addShortCut(IMAGE_SCAN_DATA, "frames", "xnat:imageScanData/frames");
		this.addShortCut(IMAGE_SCAN_DATA, "validation_method",
				"xnat:imageScanData/validation/method");
		this.addShortCut(IMAGE_SCAN_DATA, "validation_status",
				"xnat:imageScanData/validation/status");
		this.addShortCut(IMAGE_SCAN_DATA, "validation_date",
				"xnat:imageScanData/validation/date");
		this.addShortCut(IMAGE_SCAN_DATA, "validation_notes",
				"xnat:imageScanData/validation/notes");

		this.addShortCut(IMAGE_SCAN_DATA, "xnat_imagescandata_id",
				"xnat:imageScanData/xnat_imagescandata_id", true);

		this.addShortCut(IMAGE_SCAN_DATA, "scanTime",
				"xnat:imageScanData/startTime");
		this.addShortCut(IMAGE_SCAN_DATA, "coil", "xnat:mrScanData/coil");
		this.addShortCut(IMAGE_SCAN_DATA, "fieldStrength",
				"xnat:mrScanData/fieldStrength");
		this.addShortCut(IMAGE_SCAN_DATA, "marker", "xnat:mrScanData/marker");
		this.addShortCut(IMAGE_SCAN_DATA, "stabilization",
				"xnat:mrScanData/stabilization");

		this.addShortCut(IMAGE_SCAN_DATA, "orientation",
				"xnat:petScanData/parameters/orientation");
		this.addShortCut(IMAGE_SCAN_DATA, "originalFileName",
				"xnat:petScanData/parameters/originalFileName");
		this.addShortCut(IMAGE_SCAN_DATA, "systemType",
				"xnat:petScanData/parameters/systemType");
		this.addShortCut(IMAGE_SCAN_DATA, "fileType",
				"xnat:petScanData/parameters/fileType");
		this.addShortCut(IMAGE_SCAN_DATA, "transaxialFOV",
				"xnat:petScanData/parameters/transaxialFOV");
		this.addShortCut(IMAGE_SCAN_DATA, "acqType",
				"xnat:petScanData/parameters/acqType");
		this.addShortCut(IMAGE_SCAN_DATA, "facility",
				"xnat:petScanData/parameters/facility");
		this.addShortCut(IMAGE_SCAN_DATA, "numPlanes",
				"xnat:petScanData/parameters/numPlanes");
		this.addShortCut(IMAGE_SCAN_DATA, "numFrames",
				"xnat:petScanData/parameters/frames/numFrames");
		this.addShortCut(IMAGE_SCAN_DATA, "numGates",
				"xnat:petScanData/parameters/numGates");
		this.addShortCut(IMAGE_SCAN_DATA, "planeSeparation",
				"xnat:petScanData/parameters/planeSeparation");
		this.addShortCut(IMAGE_SCAN_DATA, "binSize",
				"xnat:petScanData/parameters/binSize");
		this.addShortCut(IMAGE_SCAN_DATA, "dataType",
				"xnat:petScanData/parameters/dataType");

		this.addShortCut(IMAGE_SCAN_DATA, "insert_date",
				"xnat:imageScanData/meta/insert_date", true);
		this.addShortCut(IMAGE_SCAN_DATA, "insert_user",
				"xnat:imageScanData/meta/insert_user/login", true);
		this.addShortCut(IMAGE_SCAN_DATA, "last_modified",
				"xnat:imageScanData/meta/last_modified", true);

		this.addShortCut(IMAGE_SCAN_DATA, "xsiType",
				"xnat:imageScanData/extension_item/element_name", true);

		// experiments
		this.addShortCut(EXPERIMENT_DATA, "ID", "xnat:experimentdata/id");
		this.addShortCut(EXPERIMENT_DATA, "visit_id",
		...
		this.addShortCut(EXPERIMENT_DATA, "pi_firstname",
				"xnat:experimentdata/investigator/firstname");
		this.addShortCut(EXPERIMENT_DATA, "pi_lastname",
				"xnat:experimentdata/investigator/lastname");
		this.addShortCut(EXPERIMENT_DATA, "validation_method",
				"xnat:experimentdata/validation/method");
		this.addShortCut(EXPERIMENT_DATA, "validation_status",
				"xnat:experimentdata/validation/status");
		this.addShortCut(EXPERIMENT_DATA, "validation_date",
				"xnat:experimentdata/validation/date");
		this.addShortCut(EXPERIMENT_DATA, "validation_notes",
				"xnat:experimentdata/validation/notes");
		this.addShortCut(EXPERIMENT_DATA, "project",
				"xnat:experimentdata/project");
		this.addShortCut(EXPERIMENT_DATA, "label", "xnat:experimentdata/label");

		this.addShortCut(EXPERIMENT_DATA, "scanner",
				"xnat:imagesessiondata/scanner");
		this.addShortCut(EXPERIMENT_DATA, "operator",
				"xnat:imagesessiondata/operator");
		this.addShortCut(EXPERIMENT_DATA, "dcmAccessionNumber",
				"xnat:imagesessiondata/dcmaccessionnumber");
		this.addShortCut(EXPERIMENT_DATA, "dcmPatientId",
				"xnat:imagesessiondata/dcmpatientid");
		this.addShortCut(EXPERIMENT_DATA, "dcmPatientName",
				"xnat:imagesessiondata/dcmpatientname");
		this.addShortCut(EXPERIMENT_DATA, "session_type",
				"xnat:imagesessiondata/session_type");
		this.addShortCut(EXPERIMENT_DATA, "modality",
				"xnat:imagesessiondata/modality");
		this.addShortCut(EXPERIMENT_DATA, "UID", "xnat:imagesessiondata/uid");
		this.addShortCut(EXPERIMENT_DATA, "studyInstanceUID",
				"xnat:imagesessiondata/uid");

		this.addShortCut(EXPERIMENT_DATA, "coil", "xnat:mrsessiondata/coil");
		this.addShortCut(EXPERIMENT_DATA, "fieldStrength",
				"xnat:mrsessiondata/fieldstrength");
		this.addShortCut(EXPERIMENT_DATA, "marker", "xnat:mrsessiondata/marker");
		this.addShortCut(EXPERIMENT_DATA, "stabilization",
				"xnat:mrsessiondata/stabilization");

		this.addShortCut(EXPERIMENT_DATA, "studyType",
				"xnat:petsessiondata/studytype");
		this.addShortCut(EXPERIMENT_DATA, "patientID",
				"xnat:petsessiondata/patientid");
		this.addShortCut(EXPERIMENT_DATA, "patientName",
				"xnat:petsessiondata/patientname");
		this.addShortCut(EXPERIMENT_DATA, "stabilization",
				"xnat:petsessiondata/stabilization");
		this.addShortCut(EXPERIMENT_DATA, "scan_start_time",
				"xnat:petsessiondata/start_time_scan");
		this.addShortCut(EXPERIMENT_DATA, "injection_start_time",
				"xnat:petsessiondata/start_time_injection");
		this.addShortCut(EXPERIMENT_DATA, "tracer_name",
				"xnat:petsessiondata/tracer/name");
		this.addShortCut(EXPERIMENT_DATA, "tracer_startTime",
				"xnat:petsessiondata/tracer/starttime");
		this.addShortCut(EXPERIMENT_DATA, "tracer_dose",
				"xnat:petsessiondata/tracer/dose");
		this.addShortCut(EXPERIMENT_DATA, "tracer_sa",
				"xnat:petsessiondata/tracer/specificactivity");
		this.addShortCut(EXPERIMENT_DATA, "tracer_totalmass",
				"xnat:petsessiondata/tracer/totalmass");
		this.addShortCut(EXPERIMENT_DATA, "tracer_intermediate",
				"xnat:petsessiondata/tracer/intermediate");
		this.addShortCut(EXPERIMENT_DATA, "tracer_isotope",
				"xnat:petsessiondata/tracer/isotope");
		this.addShortCut(EXPERIMENT_DATA, "tracer_isotope",
				"xnat:petsessiondata/tracer/isotope/half-life");
		this.addShortCut(EXPERIMENT_DATA, "tracer_transmissions",
				"xnat:petsessiondata/tracer/transmissions");
		this.addShortCut(EXPERIMENT_DATA, "tracer_transmissions_start",
				"xnat:petsessiondata/tracer/transmissions_starttime");

		this.addShortCut(EXPERIMENT_DATA, "subject_ID",
				"xnat:subjectassessordata/subject_id");
		this.addShortCut(EXPERIMENT_DATA, "subject_label",
				"xnat:subjectdata/label", true);
		this.addShortCut(EXPERIMENT_DATA, "subject_project",
				"xnat:subjectdata/project", true);

		this.addShortCut(EXPERIMENT_DATA, "session_ID",
				"xnat:imagesessiondata/id", true);
		this.addShortCut(EXPERIMENT_DATA, "session_label",
				"xnat:imagesessiondata/label", true);
		this.addShortCut(EXPERIMENT_DATA, "session_project",
				"xnat:imagesessiondata/project", true);

		this.addShortCut(EXPERIMENT_DATA, "insert_date",
				"xnat:experimentData/meta/insert_date", true);
		this.addShortCut(EXPERIMENT_DATA, "insert_user",
				"xnat:experimentData/meta/insert_user/login", true);
		this.addShortCut(EXPERIMENT_DATA, "last_modified",
				"xnat:experimentData/meta/last_modified", true);
		this.addShortCut(EXPERIMENT_DATA, "xsiType",
				"xnat:experimentData/extension_item/element_name", true);
		...
		this.addShortCut(SUBJECT_DATA, "birth_weight",
				"xnat:subjectData/demographics[@xsi:type=xnat:demographicData]/birth_weight");

		this.addShortCut(SUBJECT_DATA, "insert_date",
				"xnat:subjectData/meta/insert_date", true);
		this.addShortCut(SUBJECT_DATA, "insert_user",
				"xnat:subjectData/meta/insert_user/login", true);
		this.addShortCut(SUBJECT_DATA, "last_modified",
				"xnat:subjectData/meta/last_modified", true);
		...
		this.addShortCut(RECON_DATA, "baseScanType",
				"xnat:reconstructedImageData/baseScanType");
		this.addShortCut(RECON_DATA, "xnat_reconstructedimagedata_id",
				"xnat:reconstructedImageData/xnat_reconstructedimagedata_id",
				true);

		// assessor
		this.addShortCut(DERIVED_DATA, "ID", "xnat:experimentdata/ID");
		this.addShortCut(DERIVED_DATA, "visit_id",
				"xnat:experimentdata/visit_id");
		...
		this.addShortCut(DERIVED_DATA, "pi_firstname",
				"xnat:experimentdata/investigator/firstname");
		this.addShortCut(DERIVED_DATA, "pi_lastname",
				"xnat:experimentdata/investigator/lastname");
		this.addShortCut(DERIVED_DATA, "validation_method",
				"xnat:experimentdata/validation/method");
		this.addShortCut(DERIVED_DATA, "validation_status",
				"xnat:experimentdata/validation/status");
		this.addShortCut(DERIVED_DATA, "validation_date",
				"xnat:experimentdata/validation/date");
		this.addShortCut(DERIVED_DATA, "validation_notes",
				"xnat:experimentdata/validation/notes");
		...
		this.addShortCut(DERIVED_DATA, "session_ID",
				"xnat:imagesessiondata/id", true);
		this.addShortCut(DERIVED_DATA, "session_label",
				"xnat:imagesessiondata/label", true);
		this.addShortCut(DERIVED_DATA, "session_project",
				"xnat:imagesessiondata/project", true);

		this.addShortCut(DERIVED_DATA, "insert_date",
				"xnat:experimentData/meta/insert_date", true);
		this.addShortCut(DERIVED_DATA, "insert_user",
				"xnat:experimentData/meta/insert_user/login", true);
		this.addShortCut(DERIVED_DATA, "last_modified",
				"xnat:experimentData/meta/last_modified", true);
		this.addShortCut(DERIVED_DATA, "xsiType",
				"xnat:experimentData/extension_item/element_name", true);

		// project
		this.addShortCut(PROJECT_DATA, "ID", "xnat:projectData/ID");
		this.addShortCut(PROJECT_DATA, "secondary_ID",
				"xnat:projectData/secondary_ID");
		this.addShortCut(PROJECT_DATA, "name", "xnat:projectData/name");
		this.addShortCut(PROJECT_DATA, "description",
				"xnat:projectData/description");
		this.addShortCut(PROJECT_DATA, "keywords", "xnat:projectData/keywords");
		this.addShortCut(PROJECT_DATA, "alias",
				"xnat:projectData/aliases/alias/alias");
		this.addShortCut(PROJECT_DATA, "pi_firstname",
				"xnat:projectData/PI/firstname");
		this.addShortCut(PROJECT_DATA, "pi_lastname",
				"xnat:projectData/PI/lastname");
		this.addShortCut(PROJECT_DATA, "note",
				"xnat:projectData/fields/field[name=note]/field");
		...
		this.addShortCut(VISIT_DATA, "xsiType",
				"xnat:pvisitdata/extension_item/element_name", true);
		this.addShortCut(VISIT_DATA, "label", "xnat:pvisitdata/label");
		this.addShortCut(VISIT_DATA, "insert_date",
				"xnat:pvisitdata/meta/insert_date", true);
		this.addShortCut(VISIT_DATA, "insert_user",
				"xnat:pvisitdata/meta/insert_user/login", true);
		this.addShortCut(VISIT_DATA, "last_modified",
				"xnat:pvisitdata/meta/last_modified", true);
		this.addShortCut(VISIT_DATA, "subject_ID", "xnat:pvisitdata/subject_id");

	}

	public void addShortCut(final String xsiType, final String key,
			final String path) {
		this.addShortCut(xsiType, key, path, false);
	}

	public void addShortCut(final String xsiType, final String key,
			final String path, boolean readOnly) {
	 ...
	 * @return
	 */
	public static Map<String, Object> identifyUsableFields(
			final Map<String, Object> params, final String TYPE,
			boolean readOnly) {
		return XMLPathShortcuts.getInstance().identifyFields(params, TYPE,
				readOnly);
	...
	public Map<String, Object> identifyFields(final Map<String, Object> params,
			final String TYPE, boolean readOnly) {
		...
		if (params != null) {
			for (Map.Entry<String, Object> entry : params.entrySet()) {
				...
				if (shortcuts.get(TYPE).containsKey(entry.getKey())) {
					relevant.put(shortcuts.get(TYPE).get(entry.getKey()),
							entry.getValue());
				}

				if (readOnly) {
					if (readonly.get(TYPE).containsKey(entry.getKey())) {
						relevant.put(readonly.get(TYPE).get(entry.getKey()),
								entry.getValue());
					}
				}
			}
	...
	public Map<String, String> getShortcuts(String type, boolean readOnly) {
		Map<String, String> temp = new HashMap<String, String>(
				this.shortcuts.get(type));
		if (readOnly)
			temp.putAll(this.readonly.get(type));
		return temp;
	}
