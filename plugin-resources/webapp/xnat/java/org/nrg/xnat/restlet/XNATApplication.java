...
public class XNATApplication extends Application {
	...
	public static final String PREARC_SESSION_URI = PREARC_PROJECT_URI
			+ "/{SESSION_TIMESTAMP}/{SESSION_LABEL}";
	...
	private void initializeRouteTable() {
		_routeBuffer = new StringBuilder("URI\tClass\tMatching Mode")
				.append(System.getProperty("line.separator"));
	}

	private boolean isRestMockServiceEnabled() {
		try {
			final String showMockRestConfig = XDAT
					.getSiteConfigurationProperty("UI.show-mock-rest-config");
			return !StringUtils.isBlank(showMockRestConfig)
					&& Boolean.parseBoolean(showMockRestConfig);
		} catch (ConfigServiceException e) {
			return false;
		}
	}

	private void attachArchiveURI(final Router router, final String uri,
			final Class<? extends Resource> clazz) {
		attachURI(router, uri.intern(), clazz);
		attachURI(router, ("/archive" + uri).intern(), clazz);
	}

	private void attachURIs(final Router router,
			final Class<? extends Resource> clazz, final String... uris) {
		for (final String uri : uris) {
			attachURI(router, uri, clazz);
		}
	}

	private void attachURI(final Router router, final String uri,
			final Class<? extends Resource> clazz) {
		attachURI(router, uri, clazz, null);
	}

	private void attachURI(final Router router, final String uri,
			final Class<? extends Resource> clazz, Integer matchingMode) {
		if (_log.isInfoEnabled()) {
	...
	private void logAttachedRoute(final String uri,
			Class<? extends Resource> clazz, final Integer matchingMode) {
		_routeBuffer.append(uri.intern()).append("\t")
	...
	private void addRoutes(final Router router) {
		attachArchiveURI(router, "/investigators",
				InvestigatorListResource.class);

		// BEGIN ---- Pipelines section
		attachArchiveURI(router, "/projects/{PROJECT_ID}/pipelines",
				ProjectPipelineListResource.class);
		attachArchiveURI(
				router,
				"/projects/{PROJECT_ID}/pipelines/{STEP_ID}/experiments/{EXPT_ID}",
				ProjtExptPipelineResource.class);
		// END ---- Pipelines section
		attachArchiveURI(router, "/config/edit/image/dicom/{RESOURCE}",
				DicomEdit.class);
		attachArchiveURI(router,
				"/config/edit/projects/{PROJECT_ID}/image/dicom/{RESOURCE}",
				DicomEdit.class);
		attachArchiveURI(router, "/config/{PROJECT_ID}/archive_spec",
				ProjectArchive.class);
		attachArchiveURI(router, "/projects/{PROJECT_ID}/archive_spec",
				ProjectArchive.class);
		attachArchiveURI(router, "/projects/{PROJECT_ID}/experiments",
				ProjSubExptList.class);
		attachArchiveURI(router,
				"/projects/{PROJECT_ID}/experiments/{EXPT_ID}",
				ExperimentResource.class);
		attachArchiveURI(router, "/projects/{PROJECT_ID}/users",
				ProjectUserListResource.class);
		attachArchiveURI(router,
				"/projects/{PROJECT_ID}/users/{DISPLAY_HIDDEN_USERS}",
				ProjectUserListResource.class);
		attachArchiveURI(router,
		...
		attachArchiveURI(
				router,
				"/projects/{PROJECT_ID}/users/{GROUP_ID}/{USER_ID}/{DISPLAY_HIDDEN_USERS}",
				ProjectMemberResource.class);
		attachArchiveURI(router, "/projects/{PROJECT_ID}/searches/{SEARCH_ID}",
				ProjectSearchResource.class);
		attachArchiveURI(router, "/projects/{PROJECT_ID}/groups",
				ProjectGroupResource.class);
		attachArchiveURI(router, "/projects/{PROJECT_ID}/groups/{GROUP_ID}",
				ProjectGroupResource.class);
		attachArchiveURI(router, "/projects/{PROJECT_ID}/subjects",
				ProjectSubjectList.class);
		attachArchiveURI(router,
		...
		attachArchiveURI(
				router,
				"/projects/{PROJECT_ID}/subjects/{SUBJECT_ID}/experiments/{ASSESSED_ID}/reconstructions",
				ReconList.class);
		attachArchiveURI(
				router,
				"/projects/{PROJECT_ID}/subjects/{SUBJECT_ID}/experiments/{ASSESSED_ID}/reconstructions/{RECON_ID}",
				ReconResource.class);
		attachArchiveURI(router, "/projects/{PROJECT_ID}/accessibility",
				ProjectAccessibilityResource.class);
		attachArchiveURI(router,
				"/projects/{PROJECT_ID}/accessibility/{ACCESS_LEVEL}",
				ProjectAccessibilityResource.class);
		attachArchiveURI(router, "/projects/{PROJECT_ID}",
				ProjectResource.class);
		attachArchiveURI(router, "/projects", ProjectListResource.class);
		attachArchiveURI(router, "/projects/{PROJECT_ID}/scan_types",
				ScanTypeListing.class);
		attachArchiveURI(router, "/scan_types", ScanTypeListing.class);
		attachArchiveURI(router, "/scanners", ScannerListing.class);

		attachArchiveURI(router,
				"/projects/{PROJECT_ID}/protocols/{PROTOCOL_ID}",
				ProtocolResource.class);

		attachArchiveURI(router, "/experiments", ExperimentListResource.class);
		attachArchiveURI(router, "/experiments/{EXPT_ID}",
				ExperimentResource.class);
		attachArchiveURI(router, "/experiments/{ASSESSED_ID}/scans",
				ScanList.class);
		attachArchiveURI(router, "/experiments/{ASSESSED_ID}/scans/{SCAN_ID}",
				ScanResource.class);
		attachArchiveURI(router,
				"/experiments/{ASSESSED_ID}/scans/{SCAN_ID}/DICOMDIR",
				ScanDIRResource.class);
		attachArchiveURI(router, "/experiments/{ASSESSED_ID}/reconstructions",
				ReconList.class);
		attachArchiveURI(router,
				"/experiments/{ASSESSED_ID}/reconstructions/{RECON_ID}",
				ReconResource.class);
		attachArchiveURI(router, "/experiments/{ASSESSED_ID}/assessors",
				ProjSubExptAsstList.class);
		attachArchiveURI(router,
				"/experiments/{ASSESSED_ID}/assessors/{EXPT_ID}",
				ExptAssessmentResource.class);

		attachArchiveURI(router, "/subjects/{SUBJECT_ID}",
				SubjectResource.class);
		attachArchiveURI(router, "/subjects", SubjectListResource.class);

		// resources
		attachArchiveURI(router, "/projects/{PROJECT_ID}/resources",
				CatalogResourceList.class);
		attachArchiveURI(router,
		...
		attachArchiveURI(
				router,
				"/projects/{PROJECT_ID}/subjects/{SUBJECT_ID}/experiments/{ASSESSED_ID}/assessors/{EXPT_ID}/{TYPE}/resources",
				CatalogResourceList.class);
		attachArchiveURI(
				router,
				"/projects/{PROJECT_ID}/subjects/{SUBJECT_ID}/experiments/{ASSESSED_ID}/reconstructions/{RECON_ID}/{TYPE}/resources",
				CatalogResourceList.class);
		attachArchiveURI(
				router,
				"/projects/{PROJECT_ID}/subjects/{SUBJECT_ID}/experiments/{ASSESSED_ID}/scans/{SCAN_ID}/resources",
				CatalogResourceList.class);
		attachArchiveURI(router, "/experiments/{EXPT_ID}/resources",
				CatalogResourceList.class);
		attachArchiveURI(router,
				"/experiments/{ASSESSED_ID}/assessors/{EXPT_ID}/resources",
				CatalogResourceList.class);
		attachArchiveURI(
				router,
				"/experiments/{ASSESSED_ID}/reconstructions/{RECON_ID}/resources",
				CatalogResourceList.class);
		attachArchiveURI(
				router,
				"/experiments/{ASSESSED_ID}/assessors/{EXPT_ID}/{TYPE}/resources",
				CatalogResourceList.class);
		attachArchiveURI(
				router,
				"/experiments/{ASSESSED_ID}/reconstructions/{RECON_ID}/{TYPE}/resources",
				CatalogResourceList.class);
		attachArchiveURI(router,
				"/experiments/{ASSESSED_ID}/scans/{SCAN_ID}/resources",
				CatalogResourceList.class);

		attachArchiveURI(router, "/subjects/{SUBJECT_ID}/resources",
				CatalogResourceList.class);
		...
		attachArchiveURI(
				router,
				"/projects/{PROJECT_ID}/subjects/{SUBJECT_ID}/experiments/{ASSESSED_ID}/assessors/{EXPT_ID}/{TYPE}/resources/{RESOURCE_ID}",
				CatalogResource.class);
		attachArchiveURI(
				router,
				"/projects/{PROJECT_ID}/subjects/{SUBJECT_ID}/experiments/{ASSESSED_ID}/reconstructions/{RECON_ID}/{TYPE}/resources/{RESOURCE_ID}",
				CatalogResource.class);
		attachArchiveURI(
				router,
				...
				CatalogResource.class);
		attachArchiveURI(router,
				"/experiments/{EXPT_ID}/resources/{RESOURCE_ID}",
				CatalogResource.class);
		attachArchiveURI(
				router,
				"/experiments/{ASSESSED_ID}/assessors/{EXPT_ID}/resources/{RESOURCE_ID}",
				CatalogResource.class);
		attachArchiveURI(
				router,
				"/experiments/{ASSESSED_ID}/reconstructions/{RECON_ID}/resources/{RESOURCE_ID}",
				CatalogResource.class);
		attachArchiveURI(
				router,
				"/experiments/{ASSESSED_ID}/assessors/{EXPT_ID}/{TYPE}/resources/{RESOURCE_ID}",
				CatalogResource.class);
		attachArchiveURI(
				router,
				"/experiments/{ASSESSED_ID}/reconstructions/{RECON_ID}/{TYPE}/resources/{RESOURCE_ID}",
				CatalogResource.class);
		attachArchiveURI(
				router,
				"/experiments/{ASSESSED_ID}/scans/{SCAN_ID}/resources/{RESOURCE_ID}",
				CatalogResource.class);
		...
		attachArchiveURI(
				router,
				"/projects/{PROJECT_ID}/subjects/{SUBJECT_ID}/experiments/{ASSESSED_ID}/assessors/{EXPT_ID}/{TYPE}/resources/{RESOURCE_ID}/files",
				FileList.class);
		attachArchiveURI(
				router,
				"/projects/{PROJECT_ID}/subjects/{SUBJECT_ID}/experiments/{ASSESSED_ID}/reconstructions/{RECON_ID}/{TYPE}/resources/{RESOURCE_ID}/files",
				FileList.class);
		attachArchiveURI(
				router,
		...
		attachArchiveURI(
				...
				FileList.class);
		attachArchiveURI(router,
				"/experiments/{EXPT_ID}/resources/{RESOURCE_ID}/files",
				FileList.class);
		attachArchiveURI(
				router,
				"/experiments/{ASSESSED_ID}/assessors/{EXPT_ID}/resources/{RESOURCE_ID}/files",
				FileList.class);
		attachArchiveURI(
				router,
				"/experiments/{ASSESSED_ID}/reconstructions/{RECON_ID}/resources/{RESOURCE_ID}/files",
				FileList.class);
		attachArchiveURI(
				router,
				"/experiments/{ASSESSED_ID}/assessors/{EXPT_ID}/{TYPE}/resources/{RESOURCE_ID}/files",
				FileList.class);
		attachArchiveURI(
				router,
				"/experiments/{ASSESSED_ID}/reconstructions/{RECON_ID}/{TYPE}/resources/{RESOURCE_ID}/files",
				FileList.class);
		attachArchiveURI(
				router,
				"/experiments/{ASSESSED_ID}/scans/{SCAN_ID}/resources/{RESOURCE_ID}/files",
				FileList.class);

		attachArchiveURI(router,
				"/subjects/{SUBJECT_ID}/resources/{RESOURCE_ID}/files",
				FileList.class);

		// file short-cut
		attachArchiveURI(router, "/projects/{PROJECT_ID}/files", FileList.class);
		attachArchiveURI(router,
				"/projects/{PROJECT_ID}/subjects/{SUBJECT_ID}/files",
				FileList.class);
		attachArchiveURI(
				router,
				"/projects/{PROJECT_ID}/subjects/{SUBJECT_ID}/experiments/{EXPT_ID}/files",
				FileList.class);
		attachArchiveURI(
				router,
				"/projects/{PROJECT_ID}/subjects/{SUBJECT_ID}/experiments/{ASSESSED_ID}/assessors/{EXPT_ID}/{TYPE}/files",
				FileList.class);
		attachArchiveURI(
				router,
				"/projects/{PROJECT_ID}/subjects/{SUBJECT_ID}/experiments/{ASSESSED_ID}/reconstructions/{RECON_ID}/{TYPE}/files",
				FileList.class);
		attachArchiveURI(
				router,
				"/projects/{PROJECT_ID}/subjects/{SUBJECT_ID}/experiments/{ASSESSED_ID}/assessors/{EXPT_ID}/files",
				FileList.class);
		attachArchiveURI(
				router,
				"/projects/{PROJECT_ID}/subjects/{SUBJECT_ID}/experiments/{ASSESSED_ID}/reconstructions/{RECON_ID}/files",
				FileList.class);
		attachArchiveURI(
				router,
				"/projects/{PROJECT_ID}/subjects/{SUBJECT_ID}/experiments/{ASSESSED_ID}/scans/{SCAN_ID}/files",
				FileList.class);
		attachArchiveURI(router, "/experiments/{EXPT_ID}/files", FileList.class);
		attachArchiveURI(router,
				"/experiments/{ASSESSED_ID}/assessors/{EXPT_ID}/{TYPE}/files",
				FileList.class);
		attachArchiveURI(router,
				"/experiments/{ASSESSED_ID}/assessors/{EXPT_ID}/files",
				FileList.class);
		attachArchiveURI(
				router,
				"/experiments/{ASSESSED_ID}/reconstructions/{RECON_ID}/{TYPE}/files",
				FileList.class);
		attachArchiveURI(router,
				"/experiments/{ASSESSED_ID}/reconstructions/{RECON_ID}/files",
				FileList.class);
		attachArchiveURI(router,
				"/experiments/{ASSESSED_ID}/scans/{SCAN_ID}/files",
				FileList.class);

		attachArchiveURI(router, "/subjects/{SUBJECT_ID}/files", FileList.class);

		attachURI(router, "/users", UserListResource.class);
		attachURI(router, "/users/favorites/{DATA_TYPE}",
				UserFavoritesList.class);
		attachURI(router, "/users/favorites/{DATA_TYPE}/{PROJECT_ID}",
		...
		attachURI(router, "/search/elements/{ELEMENT_NAME}",
				SearchFieldListResource.class);
		attachURI(router, "/search/elements/{ELEMENT_NAME}/versions",
				SearchFieldsVersionListResource.class);
		attachURI(router, "/search/saved", SavedSearchListResource.class);
		attachURI(router, "/search/saved/{SEARCH_ID}",
				SavedSearchResource.class);
		attachURI(router, "/search/{CACHED_SEARCH_ID}",
				CachedSearchResource.class);
		attachURI(router, "/search/{CACHED_SEARCH_ID}/{COLUMN}",
				CachedSearchColumnResource.class);

		attachURI(router, "/pars", PARList.class);
		attachURI(router, "/pars/{PAR_ID}", PARResource.class);
		attachURI(router, "/projects/{PROJECT_ID}/pars",
				ProjectPARListResource.class);
		...
		attachURI(router, "/prearchive/experiments",
				RecentPrearchiveSessions.class);
		...
		attachURI(router, PREARC_SESSION_URI + "/resources",
				PrearcSessionResourcesList.class);
		attachURI(router, PREARC_SESSION_URI + "/scans",
				PrearcScansListResource.class);
		attachURI(router, PREARC_SESSION_URI + "/scans/{SCAN_ID}",
				PrearcScanResource.class);
		attachURI(router, PREARC_SESSION_URI + "/resources",
				PrearcScanResourceList.class);
		attachURI(router, PREARC_SESSION_URI
				+ "/scans/{SCAN_ID}/resources/{RESOURCE_ID}/files",
				PrearcSessionResourceFiles.class);

		attachArchiveURI(router, "/experiments/{EXPT_ID}/DIR",
				DIRResource.class);
		attachArchiveURI(router,
				"/projects/{PROJECT_ID}/experiments/{EXPT_ID}/DIR",
				DIRResource.class);
		attachArchiveURI(router, "/experiments/{EXPT_ID}/XAR",
				DIRResource.class);
		attachArchiveURI(router,
				"/projects/{PROJECT_ID}/experiments/{EXPT_ID}/XAR",
				DIRResource.class);
		attachArchiveURI(router, "/user/{USER_ID}/sessions",
				UserSessionId.class);// GET returns number of user sessions

		// Users Cache Space
		attachURI(router, "/user/cache/resources", UserCacheResource.class);
		attachURI(router, "/user/cache/resources/{XNAME}",
				UserCacheResource.class);
		attachURI(router, "/user/cache/resources/{XNAME}/files",
				UserCacheResource.class);
		attachURI(router, "/user/cache/resources/{XNAME}/files/{FILE}",
				UserCacheResource.class);

		// Configuration Service
		attachURI(router, "/config", ConfigResource.class);
		attachURI(router, "/config/{TOOL_NAME}", ConfigResource.class);
		attachURI(router, "/config/{TOOL_NAME}/{PATH_TO_FILE}",
				ConfigResource.class, Template.MODE_STARTS_WITH);
		attachURI(router, "/projects/{PROJECT_ID}/config", ConfigResource.class);
		attachURI(router, "/projects/{PROJECT_ID}/config/{TOOL_NAME}",
				ConfigResource.class);
		attachURI(router,
				"/projects/{PROJECT_ID}/config/{TOOL_NAME}/{PATH_TO_FILE}",
				ConfigResource.class, Template.MODE_STARTS_WITH);
		...
		attachURI(router, "/services/prearchive/move",
				PrearchiveBatchMove.class);
		attachURI(router, "/services/prearchive/delete",
				PrearchiveBatchDelete.class);
		attachURI(router, "/services/prearchive/rebuild",
				PrearchiveBatchRebuild.class);
		...
		attachURI(router, "/services/settings/{PROPERTY}",
				SettingsRestlet.class);
		attachURI(router, "/services/settings/{PROPERTY}/{VALUE}",
				SettingsRestlet.class);
		attachURI(router, "/services/logging/{" + Analytics.EVENT_KEY + "}",
				RemoteLoggingRestlet.class);
		attachURI(router, "/services/mail/send", MailRestlet.class);
		attachURI(router, "/services/tokens/{OPERATION}",
				AliasTokenRestlet.class);
		attachURI(router, "/services/tokens/{OPERATION}/user/{USERNAME}",
				AliasTokenRestlet.class);
		attachURI(router, "/services/tokens/{OPERATION}/{TOKEN}",
				AliasTokenRestlet.class);
		attachURI(router, "/services/tokens/{OPERATION}/{TOKEN}/{SECRET}",
				AliasTokenRestlet.class);
		...
		attachURIs(router, ScriptTriggerTemplateResource.class,
				"/automation/templates", "/automation/templates/{TEMPLATE_ID}",
				"/projects/{PROJECT_ID}/automation/templates",
				"/projects/{PROJECT_ID}/automation/templates/{TEMPLATE_ID}");

		attachURI(router, "/status/{TRANSACTION_ID}",
				SQListenerRepresentation.class);
	...
	/**
	 * This method walks the <b>org.nrg.xnat.restlet.extensions</b> package, as
	 * well as any packages defined in {@link XnatRestletExtensions} beans and
	 * attempts to find extensions for the set of available REST services.
	 *
	 * @param router
	 *            The URL router for the restlet servlet.
	 * @return A list of classes that should be attached unprotected, i.e.
	 *         publicly accessible.
	 */
	...
	private List<Class<? extends Resource>> addExtensionRoutes(Router router) {
		...
		final Map<String, XnatRestletExtensions> pkgLists = XDAT
				.getContextService()
				.getBeansOfType(XnatRestletExtensions.class);
		...
		for (String pkg : packages) {
			try {
				final List<Class<?>> classesForPackage = Reflection
						.getClassesForPackage(pkg);
				if (_log.isDebugEnabled()) {
					_log.debug("Found " + classesForPackage.size()
							+ " classes for package: " + pkg);
				}
				for (Class<?> clazz : classesForPackage) {
					if (Resource.class.isAssignableFrom(clazz)) {
						if (_log.isDebugEnabled()) {
							_log.debug("Found resource class: "
									+ clazz.getName());
						}
		...
		for (Class<? extends Resource> clazz : classes) {
			if (clazz.isAnnotationPresent(XnatRestlet.class)) {
				...
				if (urls == null || urls.length == 0) {
					throw new RuntimeException("The restlet extension class "
							+ clazz.getName() + " has no URLs configured.");
				}
				if (annotation.secure()) {
					if (_log.isDebugEnabled()) {
						_log.debug("Found XnatRestlet-annotated secure function class "
								+ clazz.getName()
								+ " for URLs: "
								+ Joiner.on(", ").join(urls));
					}
					...
					if (_log.isDebugEnabled()) {
						_log.debug("Found XnatRestlet-annotated public function class "
								+ clazz.getName()
								+ " for URLs: "
								+ Joiner.on(", ").join(urls));
					}
				...
				XnatRestlet2 annotation = clazz
						.getAnnotation(XnatRestlet2.class);
	...
	private void attachPath(Router router, Class<? extends Resource> clazz,
			XnatRestlet annotation) {
		String[] paths = annotation.value();
		boolean required = annotation.required();
		if (paths == null || paths.length == 0) {
			String message = "You must specify a value for the XnatRestlet annotation to indicate the hosting path for the restlet extension in class: "
					+ clazz.getName();
			if (required) {
	...
	private void addPublicRoutes(final Router router,
			List<Class<? extends Resource>> publicRoutes) {
	...
	/**
	 * Takes URLs from the mock REST system configuration and maps them into the
	 * REST service router. Results for the calls are handled by the
	 * {@link org.nrg.xnat.restlet.resources.RestMockCallMapRestlet}
	 * implementation.
	 *
	 * @param router
	 *            The REST service router.
	 */
	private void addConfiguredRoutes(final Router router) {
		Map<String, String> callMap = RestMockCallMapRestlet
				.getRestMockCallMap();
		if (callMap != null) {
	...
	private static final Logger _log = LoggerFactory
			.getLogger(XNATApplication.class);
