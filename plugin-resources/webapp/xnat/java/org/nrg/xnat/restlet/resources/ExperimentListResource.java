        ...
        try {
            if(this.getQueryVariable("recent")!=null){
                ...
                try {
                    ...
                    logger.debug("User attempted to access data without permission", e);
                    table=new XFTTable();
                ...
                try {
                    ...
                    if(this.getQueryVariable("recent")!=null){
                        try {
                            Integer.parseInt(this.getQueryVariable("recent"));
                        } catch (NumberFormatException e) {
                            limit=true;
                        }
                    }
                    ...
                    query=String.format("SELECT * FROM (" +
                            ...
                            "RIGHT JOIN (%s) perm ON expt.id=perm.id " +
                        ...
                        ")SEARCH WHERE id IS NOT NULL ORDER BY action_date DESC", query);
