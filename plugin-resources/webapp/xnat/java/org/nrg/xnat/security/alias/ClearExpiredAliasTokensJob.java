...
public class ClearExpiredAliasTokensJob implements JobInterface {
	...
	public void init(final JobExecutionContext context)
		...
		if (_log.isDebugEnabled()) {
			_log.debug("Initializing the alias token sweeper job with an interval of: "
					+ _timeout);
		}
	}
	...
	public void execute() throws JobExecutionException {
		...
		if (_queries == null) {
			throw new JobExecutionException(
					"No queries defined for the expired alias tokens job: you must provide queries to clear expired tokens");
		}
	...
	private static final Log _log = LogFactory
			.getLog(ClearExpiredAliasTokensJob.class);
