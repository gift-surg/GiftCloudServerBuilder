...
public interface XnatAuthenticationProvider extends AuthenticationProvider {
	/**
	 * Gets the display name for the XNAT authentication provider. This is
	 * what's displayed to the user when selecting the authentication method.
	 * 
	...
	/**
	 * Gets the provider ID for the XNAT authentication provider. This is used
	 * to map the properties associated with the provider instance.
	 * 
	...
	/**
	 * Indicates the authentication method associated with this provider. This
	 * is used to locate the provider based on the user's selected
