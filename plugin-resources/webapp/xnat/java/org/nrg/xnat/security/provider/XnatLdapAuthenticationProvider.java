...
public class XnatLdapAuthenticationProvider extends LdapAuthenticationProvider
		implements XnatAuthenticationProvider {
	...
	public boolean supports(Class<?> authentication) {
		...
		if (XnatLdapUsernamePasswordAuthenticationToken.class
	...
	public Authentication authenticate(Authentication authentication)
		...
		if (_log.isDebugEnabled()) {
			_log.debug("Found auth object of type: " + auth.getClass()
					+ " (principal is: " + auth.getPrincipal().getClass() + ")");
		}

		/*
		 * Unlike the other authentication providers, we hafta do this check
		 * here. This class is on a different branch of the class hierarchy, and
		 * so doesn't inherit additionalAuthenticationChecks.
		 */
	...
	private static final Log _log = LogFactory
			.getLog(XnatLdapAuthenticationProvider.class);
