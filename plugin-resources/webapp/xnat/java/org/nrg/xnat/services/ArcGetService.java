...
public class ArcGetService {
	static org.apache.log4j.Logger logger = Logger
			.getLogger(ArcGetService.class);
	// public String search(String _id, ArrayList rawScanTypes,ArrayList
	// processedScanTypes,String zippedFileType) throws RemoteException
	// {
	...
	// }
	//
	// public String search(String session_id,String _id, ArrayList
	// rawScanTypes,ArrayList processedScanTypes,String zippedFileType) throws
	// RemoteException
	// {
	...
	// }
	//
	// private String search(XDATUser user,String id, ArrayList
	// rawScanTypes,ArrayList processedScanTypes,String zippedFileType) throws
	// RemoteException
	// {
	// try {
	// ArrayList al =
	// XnatMrsessiondata.getXnatMrsessiondatasByField("xnat:mrSessionData.ID",id,user,true);
	// if (al.size()== 0)
	// {
	...
	// String urlString = TurbineUtils.GetServer() +
	// "/app/template/ArcGet.vm/session/" + service_session + "/id/" + id;
	...
	// startTime;
	// // System.out.println("Temp File Complete (" + serviceDuration +
	// " ms). ");
	//
	...
	// }
	//
	// private DataHandler fromXML(String _session, String xml)throws
	// RemoteException{
	...
	// }
	//
	// private DataHandler fromXML(XDATUser user, String xml) throws
	// RemoteException{
	...
	// tempFile.delete();
	// File tempSession = new File(tempFile.getAbsolutePath() + File.separator +
	// mr.getId());
	// tempSession.mkdirs();
	//
	...
	// }
	//
	// public static DataHandler FromXML(String _session,String xml) throws
	// RemoteException
	// {
	...
	//
	//
	// public static String Search(String _id,String zippedFileType) throws
	// RemoteException
	// {
	// return (new ArcGetService()).search(_id,null,null,zippedFileType);
	// }
	//
	// public static String Search(String _id, ArrayList rawScanTypes,ArrayList
	// processedScanTypes,String zippedFileType) throws RemoteException
	// {
	// return (new
	// ArcGetService()).search(_id,rawScanTypes,processedScanTypes,zippedFileType);
	// }
	//
	// public static String Search(String _session,String _id, ArrayList
	// rawScanTypes,ArrayList processedScanTypes,String zippedFileType) throws
	// RemoteException
	// {
	// return (new
	// ArcGetService()).search(_session,_id,rawScanTypes,processedScanTypes,zippedFileType);
	// }
}
