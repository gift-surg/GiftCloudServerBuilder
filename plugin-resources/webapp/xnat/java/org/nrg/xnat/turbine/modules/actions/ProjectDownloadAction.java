...
public class ProjectDownloadAction extends SecureAction {
	static org.apache.log4j.Logger logger = Logger
			.getLogger(ProjectDownloadAction.class);
