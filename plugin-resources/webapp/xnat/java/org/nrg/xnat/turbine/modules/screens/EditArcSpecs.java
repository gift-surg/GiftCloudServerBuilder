...
public class EditArcSpecs extends AdminScreen {
	...
	protected void doBuildTemplate(RunData data, Context context)
		...
		if (arcSpec == null) {
			arcSpec = ArcSpecManager.initialize((UserI) TurbineUtils
					.getUser(data));
		}
	 ...
	 *
	 * @param arcSpec
	 *            The archive specification object.
	 * @throws Exception
	 */
	private void checkNotifications(ArcArchivespecification arcSpec)
			throws Exception {
	...
	private void clearArcSpecNotifications(ArcArchivespecification arcSpec) {
		...
		while ((notificationTypes = arcSpec
