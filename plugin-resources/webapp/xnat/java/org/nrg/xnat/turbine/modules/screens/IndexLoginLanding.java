...
public class IndexLoginLanding extends SecureScreen {
    ...
    protected void doBuildTemplate(RunData data, Context context) throws Exception {
        ...
        if(((String) TurbineUtils.GetPassedParameter("node",data))!=null){
        	context.put("node", ((String) TurbineUtils.GetPassedParameter("node",data)));
        }
