...
public class PipelineScreen_protocolcheck_add extends
		PipelineScreen_add_project_pipeline {
	...
	public void finalProcessing(RunData data, Context context) {
		try {
			...
			for (int i = 0; i < elementsAll.size(); i++) {
				if (!((String) elementsAll.get(i)).startsWith("xdat:")
						&& !((String) elementsAll.get(i)).startsWith("prov:")
						&& !((String) elementsAll.get(i)).startsWith("wrk:")
						&& !((String) elementsAll.get(i)).startsWith("val:")) {
