...
public class XDATScreen_add_pipeline extends AdminEditScreenA {
	...
	public void doBuildTemplate(RunData data, Context context) {
		try {
			ArrayList<GenericWrapperElement> elements = GenericWrapperElement
			...
			for (int i = 0; i < elements.size(); i++) {
				...
				if (!element.getFullXMLName().startsWith("cat:")
						&& !element.getFullXMLName().startsWith("pipe:")
						&& !element.getFullXMLName().startsWith("arc:")
						&& !element.getFullXMLName().startsWith("prov:")
						&& !element.getFullXMLName().startsWith("xdat:")
						&& !element.getFullXMLName().startsWith("wrk:")) {
