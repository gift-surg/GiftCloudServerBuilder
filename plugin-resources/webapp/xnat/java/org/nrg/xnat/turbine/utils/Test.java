...
public class Test {
	...
	public static void main(String[] args) {
		try {
			...
			// XFTItem item =
			// ItemSearch.GetItem("cnda:atlasScalingFactorData/ID","990413_97427_ASF_9501161738",user,false);
			// CndaAtlasscalingfactordata asf = new
			// CndaAtlasscalingfactordata(item);
			// XnatMrsessiondata mr = asf.getMrSessionData();

			// Hashtable hash
			// =XNATUtils.getInvestigatorsForCreate("xnat:subjectData",user);

			// org.nrg.xft.XFTTool.StoreXMLFileToDB(appDir +
			// "\\work\\000510_vc4309.xml",user,Boolean.FALSE);
			...
			// item.setProperty("investigator.xnat_investigatorData_id",new
			// Integer(1));
