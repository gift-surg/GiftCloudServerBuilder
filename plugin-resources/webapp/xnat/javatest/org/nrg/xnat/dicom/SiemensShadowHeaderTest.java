...
public final class SiemensShadowHeaderTest extends DicomDataUsingTestCase {
	private static final String[] columns = { "tag", // tag name, never empty.
			"subtag", // for normal, non-sequence DICOM tags this is the empty
						// string.
	...
	public void testImageInstanceShadowHeader() throws IOException {
		...
		SiemensShadowHeader.addRows(table, o, o.get(0x00291010),
	...
	@Test
	public void testImageInstanceShadowHeaderSelectedFields()
			throws IOException {
		XFTTable table = new XFTTable();
		table.initTable(columns);
		table.resetRowCursor();
		...
		final Set<String> fields = ImmutableSet.of("SlicePosition_PCS",
				"MultistepIndex");
