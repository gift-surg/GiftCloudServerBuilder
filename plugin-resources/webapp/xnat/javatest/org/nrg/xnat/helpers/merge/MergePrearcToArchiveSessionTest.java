...
public class MergePrearcToArchiveSessionTest extends BaseXDATTestCase {
	...
	/**
	 * Test method for
	 * {@link org.nrg.xnat.helpers.merge.MergeSessionsA#checkForConflict()}.
	 */
	@Test
	public void testCheckForConflict() throws Exception {
		...
		MergePrearcToArchiveSession test = new MergePrearcToArchiveSession("",
				src, newMR, null, dest, mr, null, false, false, null, null,
				null);
		try {
			...
			if (!e.getMessage().equals(MergePrearcToArchiveSession.HAS_FILES)) {
				fail("Expected '" + MergePrearcToArchiveSession.HAS_FILES
	...
	public void testCheckForConflict2() throws Exception {
		...
		MergePrearcToArchiveSession test = new MergePrearcToArchiveSession("",
				src, newMR, null, dest, mr, null, true, false, null, null, null);
		test.checkForConflict();
	}
	...
	public void testCheckForConflict4() throws Exception {
		...
		MergePrearcToArchiveSession test = new MergePrearcToArchiveSession("",
				src, newMR, null, dest, mr, null, true, true, null, null, null);
		test.checkForConflict();
