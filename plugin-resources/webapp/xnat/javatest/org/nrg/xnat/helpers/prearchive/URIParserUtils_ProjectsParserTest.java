...
public class URIParserUtils_ProjectsParserTest {
	...
	public final void sessionUriToProjectsParser(
			PrearcUriParserUtils.ProjectsParser parser) {
	...
	public final void multipleProjects(
			PrearcUriParserUtils.ProjectsParser parser) {
		String uri = "prearchive/projects/proj1,proj2,proj3";
		final List<String> ls = parser.readUri(uri);
		assert (ls.size() == 3 && ls.contains((String) "proj1")
				&& ls.contains((String) "proj2") && ls
					.contains((String) "proj3"));
	}

	public final void unassignedProjectToNull(
			PrearcUriParserUtils.ProjectsParser parser) {
