...
public class CatalogUtilsTest {
	...
	public void testAddRemoveFiles() throws Exception {
		...
		final File target2 = new File(
				"./CatalogUtilsTest/test/dummy/dummy2.txt");
		...
		assertEquals(
				"Expected CatalogUtils.addUnreferencedFiles to find 2 files",
				CatalogUtils.getEntriesByFilter(cat, new CatEntryFilterI() {
					@Override
		...
		CatalogUtils.formalizeCatalog(cat, src.getParent(), null, null, false,
				false);
