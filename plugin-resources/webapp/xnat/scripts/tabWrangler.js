...
$(function(){
    ...
    if (!$('link[href*="tabWrangler.css"]').length){
        $('head').append('<link rel="stylesheet" type="text/css" href="'+serverRoot+'/style/tabWrangler.css">');
    }
});
                ...
                if ($flipper.hasClass('right')){
                    ...
                    var nextTab = function(){
                        ...
                        if (!$next_tab.has('select').length){
                            ...
                            $next_tab.trigger('click').addClass('selected');
                        }
                    };
...
//                }
                ...
                if ($flipper.hasClass('last')){
                    ...
                    $tabs.find('li.last').trigger('click').addClass('selected');
