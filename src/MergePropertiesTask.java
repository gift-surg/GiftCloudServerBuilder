...
{ 
   ...
   { 
       ...
       List merge = loadFile(overrideFile); 
    ...
    */ 
   private Properties loadProperties(List source, List merge) throws BuildException 
   { 
    ...
    */ 
   private void writeFile(List source, List merge, Properties props) 
       throws BuildException 
   { 
