...
public class MergePropertiesTask extends Task {
	 ...
	 * 
	 * @param spec
	 *            The filespec to match properties files in the folder.
	 */
	@SuppressWarnings("unused")
	 ...
	 *
	 * @param folder
	 *            The folder containing properties files.
	 * @param spec
	 *            The filespec to match properties files in the folder.
	 ...
	 * @throws BuildException
	 *             An exception can occur if the version file is corrupted or
	 *             the process is in someway interrupted
	 */
	private List<String> loadFiles(final File folder, final String spec)
			throws BuildException {
	 ...
	 */
	private Properties loadProperties(List<String> source, List<String> merge)
			throws BuildException {
	 ...
	 */
	private void writeFile(List<String> source, List<String> merge,
	 ...
	 *
	 * @param allProps
	 *            A collection of all properties found between the source and
	 ...
	 */
	private void writeNewProperties(List<String> list, Properties props,
