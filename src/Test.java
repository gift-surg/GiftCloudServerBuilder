...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			URL requestSessionURL = new URL(siteurl
			...
			try {
				...
				params = new Object[] { service_session, "xnat:mrSessionData",
						cal.getTime() };
				// SEND SEARCH
				...
				for (int i = 0; i < ids.length; i++) {
					...
					URL url = new URL(siteurl
							+ "app/template/MRXMLSearch.vm/session/"
							+ service_session + "/id/" + id
							+ "/data_type/xnat:mrSessionData/adjustPath/"
							+ adjustPath);
					// Use Buffered Stream for reading/writing.
					BufferedInputStream bis = null;
					BufferedOutputStream bos = null;

					File outFile = new File(workDir, id + "_" + adjustPath
							+ ".xml");
