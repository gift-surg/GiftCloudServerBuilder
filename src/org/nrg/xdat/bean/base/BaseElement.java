...
public abstract class BaseElement {
	...
	// {data,single_reference,multi_reference,inline_repeater,LONG_DATA,NO_CHILD}
	...
	public Boolean formatBoolean(String s) {
		...
		throw new IllegalArgumentException("Unable to translate '" + s
				+ "' to a boolean value.");
	}
	...
	private static List<String> formatsDT = Arrays.asList(
			...
			"yyyy-MM-dd HH:mm:ss.S".intern(), "yyyy-MM-dd HH:mm:ss".intern(),
			"EEE MMM dd HH:mm:ss.S".intern(), "yyyy-MM-dd HH:mm:ss z".intern(),
			"EEE MMM dd HH:mm:ss".intern(), "EEE MMM dd HH:mm:ss z".intern(),
			"MM/dd/yyyy".intern(), "yyyy-MM-dd".intern());
	...
	public void setDataField(String xmlPath, String s)
			throws UnknownFieldException {
		if (!"schemaLocation".equals(xmlPath))
			throw new UnknownFieldException(xmlPath);
	}

	public void setReferenceField(String xmlPath, BaseElement s)
			throws UnknownFieldException {
		throw new UnknownFieldException(xmlPath);
	}
	...
	public String getReferenceFieldName(String xmlPath)
			throws BaseElement.UnknownFieldException {
		throw new UnknownFieldException(xmlPath);
	}

	public Object getReferenceField(String xmlPath)
			throws BaseElement.UnknownFieldException {
		throw new UnknownFieldException(xmlPath);
	}

	public Object getDataFieldValue(String xmlPath)
			throws BaseElement.UnknownFieldException {
		throw new UnknownFieldException(xmlPath);
	}
					...
					if (ft.equals(BaseElement.field_data)
						...
						if (o1 instanceof ArrayList) {
							...
							for (int j = 0; j < children1.size(); j++) {
								base2.setReferenceField(path, children1.get(j)
										.copy());
							}
						} else if (o1 != null) {
	...
	protected boolean addXMLBody(java.io.Writer writer, int header)
	...
	public abstract void toXML(java.io.Writer os, boolean prettyPrint)
			throws java.io.IOException;
